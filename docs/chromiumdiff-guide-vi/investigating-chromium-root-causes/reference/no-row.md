...
Với A3 và A4, dùng
[thủ tục đọc source/lịch sử trực tiếp](../../analyzing-chromium-upgrades/reference/history.md).
...
refresh, theo
[thủ tục giữ input đã lưu](../../analyzing-chromium-upgrades/reference/investigation.md)
của skill phân tích.

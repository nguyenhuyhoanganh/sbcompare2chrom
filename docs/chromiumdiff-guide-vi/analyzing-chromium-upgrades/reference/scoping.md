...
- `--partition` giới hạn việc tải vào các đường dẫn được công cụ hỗ trợ cho
  khu vực đã chọn. Nó không bao quát hết hành vi của khu vực đó. Coverage vẫn
  được tính trên toàn bộ cây, nên removal của những loại file mà partition chỉ
  đọc trong thư mục gốc của nó sẽ bị gắn cờ `unconfirmed`. Chỉ dùng sau khi
